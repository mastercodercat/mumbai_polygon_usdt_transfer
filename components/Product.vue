<template>
  ...
  >
    ...
    >
      ...
      >
        <button
          class="h-full bg-gray-200 text-gray-900 hover:bg-gray-300 transition-all ease-out duration-300 px-2 py-3 flex items-center md:col-span-1"
        >
          <img
            src="~/assets/icons/save.png"
            class="w-[25px] mx-auto h-[25px]"
            alt=""
          />
        </button>
        <button
